...
pub trait Theme<V = Variant> {
    fn primary(&self, variant: V) -> Hsla;
    fn secondary(&self, variant: V) -> Hsla;

    fn on_primary(&self, variant: V) -> Hsla;
    fn on_secondary(&self, variant: V) -> Hsla;
    ...
    // TODO: add these functinality
    // fn overlay(&self, elevation: usize) -> f32;
    // fn elevation(&self, overlay: f32) -> usize;
}
...
mod tests {
    ...
    // #[test]
    // fn primary_test() {
    //     let primary = AnaamTheme::new().primary(Variant::L500);
    //     panic!("{:#?}", primary)
    // }
}
