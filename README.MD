...
Preview:
![Screenshot](doc-resources/simple-counter.webm)
...
Preview:
![Screenshot](doc-resources/counter-using-savory-elements.webm)
...
if you want build your own element in some way, you can stil use Savory elements
