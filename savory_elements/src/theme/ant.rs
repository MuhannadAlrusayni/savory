...
impl Ant {
    ...
    fn button_normal<'a>(&self, btn: button::ButtonLens<'a>) -> button::Style {
        todo!()
        // // colors
    ...
    fn button_suggestion<'a>(&self, btn: button::ButtonLens<'a>) -> button::Style {
        todo!()
        // // colors
        // let (bg, fg, border_color) =
        //     match (btn.is_disabled(), btn.is_focused(), btn.is_mouse_over()) {
    ...
    fn button_destructive<'a>(&self, btn: button::ButtonLens<'a>) -> button::Style {
        todo!()
        // // colors
        // let (bg, fg, border_color) =
        //     match (btn.is_disabled(), btn.is_focused(), btn.is_mouse_over()) {
    ...
    fn button_link<'a>(&self, btn: button::ButtonLens<'a>) -> button::Style {
        todo!()
        // // colors
    ...
    fn button_dashed<'a>(&self, btn: button::ButtonLens<'a>) -> css::Style {
        todo!()
        //     // colors
...
impl ThemeImpl for Ant {
    fn flexbox<'a>(&self, lens: flexbox::FlexboxLens<'a>) -> flexbox::Style {
        flexbox::Style::default().and_flexbox(|conf| {
            conf.set_display(val::Flex)
                .try_set_flex_direction(lens.direction.map(|v| *v))
                .try_set_flex_wrap(lens.wrap.map(|v| *v))
                .try_set_justify_content(lens.justify_content.map(|v| *v))
                .try_set_align_items(lens.align_items.map(|v| *v))
                .try_set_align_content(lens.align_content.map(|v| *v))
                .try_set_gap(lens.gap.map(|v| *v))
        })
    }

    fn flexbox_item<'a>(&self, lens: flexbox::item::ItemLens<'a>) -> flexbox::item::Style {
        flexbox::item::Style::default().and_item(|conf| {
            conf.try_add(St::Order, lens.order.map(|v| *v))
                .try_add(St::FlexGrow, lens.grow.map(|v| *v))
                .try_add(St::FlexShrink, lens.shrink.map(|v| *v))
    ...
    fn html_icon<'a>(&self, icon: icon::html::HtmlLens<'a>) -> icon::html::Style {
        todo!()
        // Style::default().merge(icon.user_style())
    }

    fn url_icon<'a>(&self, icon: icon::url::UrlLens<'a>) -> icon::url::Style {
        todo!()
        // Style::default().merge(icon.user_style())
    }
    ...
    fn button<'a>(&self, btn: button::ButtonLens<'a>) -> button::Style {
        todo!()
    ...
    fn checkbox<'a>(&self, checkbox: checkbox::CheckboxLens<'a>) -> checkbox::Style {
        todo!()
    ...
    fn radio<'a>(&self, radio: radio::RadioLens<'a>) -> radio::Style {
        todo!()
        // let (bg, fg, border) = match (
        //     radio.is_disabled(),
        //     radio.is_focused(),
    ...
    fn entry<'a>(&self, entry: entry::EntryLens<'a>) -> entry::Style {
        todo!()
        // let (bg, fg, border) = match (
        //     entry.is_disabled(),
        //     entry.is_focused(),
    ...
    fn spin_entry<'a>(&self, spin_entry: spin_entry::SpinEntryLens<'a>) -> spin_entry::Style {
        todo!()
        // let (bg, fg, border) = match (
    ...
    fn dialog<'a>(&self, dialog: dialog::DialogLens<'a>) -> dialog::Style {
        todo!()
        // Style::default()
    ...
    fn header_bar<'a>(&self, header_bar: header_bar::HeaderBarLens<'a>) -> header_bar::Style {
        todo!()
        // // em units
        // let height = 2.5;
    ...
    fn progress_bar<'a>(
        &self,
        progress_bar: progress_bar::ProgressBarLens<'a>,
    ) -> progress_bar::Style {
        todo!()
        // // em units
        // let height = 0.7;
