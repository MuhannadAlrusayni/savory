use super::{St, StyleValues, UpdateStyleValues};
...
impl UpdateStyleValues for Opacity {
    fn update_style_values(self, values: StyleValues) -> StyleValues {
        values.add(St::Opacity, self.0)
    }
}
